"""
This module creates all progressive performance feature tables used for 
machine-learning modelling of Formula 1 race outcomes.

Unlike the static summary tables in features.py, the progressive features calculated 
here strictly use only historical data available before a given race or season,
thus avoiding any data leakage.
"""
...
def build_qualifying_progressive_performance() -> Path:
    ...
    perf_all = grouped_all.agg(
        ...
        surname = ("surname", "first"),
        driver_nationality = ("driver_nationality", "first"),
        quali_sessions_count = ("session", "sum"),
        quali_sessions_quali = ("valid_session", "sum"),
        quali_top5_finishes = ("top5", "sum"),
        quali_top10_finishes = ("top10", "sum"),
        quali_pole_count = ("pole", "sum"),
        quali_front_row_count = ("front_row", "sum"),
        quali_q2_appearances = ("in_q2", "sum"),
        quali_q3_appearances = ("in_q3", "sum"),
        quali_avg_quali_position = ("position", "mean"),
        quali_med_quali_position = ("position", "median"),
        quali_std_quali_position = ("position", "std"),)
    ...
    cum_columns = [
        ...
        "quali_sessions_quali",
        "quali_top5_finishes",
        "quali_top10_finishes",
        "quali_pole_count",
        "quali_front_row_count",
        "quali_q2_appearances",
        "quali_q3_appearances",]
    ...
    # Recompute derived rates and scores from cumulative counts
    sessions_nonzero = grouped_all["quali_sessions_count"].replace(0, np.nan)
    valid_nonzero = grouped_all["quali_sessions_quali"].replace(0, np.nan)

    grouped_all["quali_sessions_rate"] = grouped_all["quali_sessions_quali"] / sessions_nonzero
    grouped_all["quali_pole_rate"] = grouped_all["quali_pole_count"] / valid_nonzero
    grouped_all["quali_q3_rate"] = grouped_all["quali_q3_appearances"] / valid_nonzero
    top10_rate = grouped_all["quali_top10_finishes"] / valid_nonzero
    front_row_rate = grouped_all["quali_front_row_count"] / valid_nonzero
    ...
    ordered_columns = [
        ...
        "quali_q3_appearances",
        "quali_q3_rate",
        "quali_avg_quali_position",
        "quali_med_quali_position",
        "quali_std_quali_position",]
