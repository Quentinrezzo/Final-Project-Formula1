...
- Feature engineering (example: track type and team performance metrics)
...
- Extend the model to forecast the Constructors’ Championship standings and the overall season winner, or to simulate results across an entire Formula1 season